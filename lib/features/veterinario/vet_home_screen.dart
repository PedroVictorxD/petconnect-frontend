...
class _VetHomeScreenState extends State<VetHomeScreen> with TickerProviderStateMixin {
                ...
                children: [
                      ...
                      child: Center(
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            ...
                            fit: BoxFit.cover,
                            errorBuilder: (context, error, stackTrace) =>
                                const Icon(Icons.pets, size: 120, color: Colors.white30),
                          ),
                        ),
                      ),
                    ),
                  _buildDetailRow('Tutor:', pet.ownerName ?? 'Não informado'),
                  _buildContactRow(pet.ownerPhone),
                  ...
                  if (pet.notes != null && pet.notes!.isNotEmpty)
                    Padding(
                      ...
                      child: _buildDetailRow('Notas:', pet.notes!),
                    ),
                ],
              ),
            ),
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(color: Colors.green.shade200, fontSize: 11, fontStyle: FontStyle.italic),
        ),
      ],
    );
  }
  ...
  void _launchWhatsApp(String phoneNumber) async {
    ...
    final whatsappUrl = "https://wa.me/55$cleanPhoneNumber";
